...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        return sendResponse(ProductResource::collection($posts), 'Posts retrieved successfully.');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $success = new ProductResource($post);
    ...
    public function show($id)
    {
        ...
        return sendResponse(new ProductResource($post), 'Post retrieved successfully.');
    }
